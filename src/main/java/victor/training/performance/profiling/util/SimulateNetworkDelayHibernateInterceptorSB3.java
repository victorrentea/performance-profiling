...
//
//@Component
//public class SimulateNetworkDelayHibernateInterceptorSB3 implements Interceptor {
//
//  private static final Logger log = LoggerFactory.getLogger(SimulateNetworkDelayHibernateInterceptorSB3.class);
